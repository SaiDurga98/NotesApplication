...
import com.techie.notes.security.services.jwt.AuthEntryPointJwt;
import com.techie.notes.security.services.jwt.AuthTokenFilter;
...
public class SecurityConfig {
    ...
    // Here we are making use of JdbcUserDetailsManager which takes datasource from application.properties file and loads the data to database
    // AuthenticationManager -> DaoAuthenticationProvider -> UserDetailsService -> JdbcUserDetailsManager
   /* @Bean
